...
//                if (array.getClass().getSimpleName())
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Toast.makeText(MainActivity1.this, item.getItemId() , Toast.LENGTH_SHORT).show();
        ...
        switch (item){
            case "BACK":{
               ...
               // finish();
                return;}
            case "SEARCH":{
                Toast.makeText(MainActivity1.this, "search" , Toast.LENGTH_SHORT).show();

                return;
            }
            case "SETTING":{
                Toast.makeText(MainActivity1.this, "setting" , Toast.LENGTH_SHORT).show();
